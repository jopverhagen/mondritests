...
def main():
    ...
    parser.add_argument("-opt", type=str, default="train.yml", help="Path to option YMAL file.")
    parser.add_argument(
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            timesteps, states = mondri.generate_random_states(x0=GT, mu=LQ)

            model.feed_data(states, LQ, GT) # xt, mu, x0
            model.optimize_parameters(current_step, timesteps, mondri)
